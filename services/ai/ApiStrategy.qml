...
QtObject {
    ...
    function buildRequestData(model: AiModel, messages, systemPrompt: string, temperature: real, tools: list<var>, filePaths: var) { throw new Error("Not implemented") }
    ...
    function buildScriptFileSetup(filePaths: var): string { return "" } // Default: no setup
