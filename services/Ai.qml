...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "nemotron-3.5-lightning": aiModelComponent.createObject(this, {
            "name": "Nemotron 3.5 Lightning",
            "icon": "spark-symbolic",
            "description": Translation.tr("Online | Free AI LLM from Openrouter"),
            "homepage": "https://openrouter.ai/nvidia/nemotron-3.5-lightning:free",
            "endpoint": "https://openrouter.ai/api/v1/chat/completions",
            "model": "nvidia/nemotron-3.5-lightning:free",
            "requires_key": true,
            "key_id": "openrouter",
            "key_get_link": "https://openrouter.ai/settings/keys",
            "key_get_description": Translation.tr("**Pricing**: free. Data used for training.\n\n**Instructions**: Log into Google account, allow Openrouter and click Get API key"),
            "api_format": "openai",
        }),
        "nemotron-3.5-lightning": aiModelComponent.createObject(this, {
            ...
            "icon": "spark-symbolic",
            "description": Translation.tr("Online | Free AI LLM from Openrouter"),
            "homepage": "https://openrouter.ai/nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free",
            "endpoint": "https://openrouter.ai/api/v1/chat/completions",
