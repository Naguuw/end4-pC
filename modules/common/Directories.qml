...
Singleton {
    ...
    property string booruDownloads: FileUtils.trimFileProtocol(Directories.pictures  + "/weeb")
    property string booruDownloadsNsfw: FileUtils.trimFileProtocol(Directories.pictures + "/weeb/spicy")
